...
<style>
    body{
        background:url('https://seopic.699pic.com/photo/50100/3335.jpg_wh1200.jpg') repeat-x;
    }

</style>
<body>
    <form id="loginForm">
        <div class="container-login" style="width:500px;height:300px;margin-top:200px;background-color:rgba(252, 252, 252, 0.7)">
            <h1 class="title" style="font-weight:400;display:inline;margin-bottom:60px;">旅游购物小程序管理员登录</h1>
            <div class="layui-form-item">
                <label class="layui-icon layui-icon-username" style="margin-left:10px; margin-right:10px;"></label>
                <input type="text" name="username" lay-verify="required" placeholder="用户名" class="layui-input">
            </div>
            <div class="layui-form-item">
                <label class="layui-icon layui-icon-password" style="margin-left:10px;margin-right:10px"></label>
            ...
            <div class="layui-form-item">
                <button type="button" class="layui-btn layui-btn-fluid" lay-submit lay-filter="loginSubmit" style="margin-top:20px;">登  录</button>
            </div>
        </div>
